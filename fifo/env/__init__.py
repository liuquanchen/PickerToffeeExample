...
from .RM import FIFORefModelFunc, FIFORefModelCtrl

class SyncFIFOEnvFunc(Env):
    ...
    def __init__(self, fifo_bundle: SyncFIFOBundle, fifo_internal_bundle: InternalBundle):
        ...
        self.attach(FIFORefModelFunc())

class SyncFIFOEnvCtrl(Env):
    """一个包含两个栈接口 Agent 的验证环境示例"""
    def __init__(self, fifo_bundle: SyncFIFOBundle, fifo_internal_bundle: InternalBundle):
        # 调用父类的初始化方法
        super().__init__()
